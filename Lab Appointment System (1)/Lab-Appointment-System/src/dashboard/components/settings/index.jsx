            ...
            <div className="grid grid-flow-col gap-3">
              <div className="col-span-1">
                <div className="w-full max-w-lg">
                  <h1 className="text-xl font-semibold mb-10">Personal Information</h1>
                  ...
                  <button type="submit" className="mt-10  bg-blue-700 hover:bg-blue-800 font-semibold text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded w-64">
                    Save Personal Data
                  </button>
              ...
              {/* <div className="col-span-4 flex">
                ...
                <div className="w-full max-w-lg ml-20">
                  <h1 className="text-xl font-semibold mb-10">Billing Information</h1>
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                      <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="grid-first-name">
                        Card Type
